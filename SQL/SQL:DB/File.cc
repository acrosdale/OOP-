...
File :: File () : fileDescriptor(-1), fileName(""), curLength(0) ,CurrPage(0) {
}
...
off_t File ::GetCurrPage(){
	return CurrPage;
}
void File ::SetCurrPage(off_t whichPage){
	CurrPage = whichPage;// this is because the first page has no data
}
